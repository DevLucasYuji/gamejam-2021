...
function Player:loadAssets()
   self.jumpSound = love.audio.newSource("assets/sfx/player_jump.ogg", "static")
   self.collectCoinSound = love.audio.newSource("assets/sfx/player_get_coin.ogg", "static")
   self.takeDamageSound = love.audio.newSource("assets/sfx/player_hit.ogg", "static")
...
function Player:takeDamage(amount)
   self.takeDamageSound:stop()
   self.takeDamageSound:play()
   self:tintRed()
